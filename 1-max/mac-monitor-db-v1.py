...
function closeChartModal() {
  document.getElementById(\'chartModal\').classList.remove(\'show\');
    ...
    def show_new_max_notification(self, apt_list):
        ...
        title_label = tk.Label(header_main, text="부태리의 신고가", font=scaled_font(get_mac_font(), 18, 'bold'), bg=colors['primary'], fg='white')
        title_label.pack()
        ...
        html_button = tk.Button(
            ...
            command=lambda fn=_fixed_filename: self.export_notification_html(apt_list, ask_path=False, silent=False, fixed_filename=fn)
        )
