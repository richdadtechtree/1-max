...
class RealEstateMonitorApp:
    ...
    def setup_gui(self):
        ...
        # '서울 수도권' 리스트에서만 활성화
        if self.active_list.get() != "서울 수도권":
...
총 추가된 단지: {total_added}개"""
    ...
    def export_notification_html(self, apt_list, *, ask_path=False, silent=False):
        ...
        try:
            ...
            if ask_path:
                ...
                from tkinter import filedialog
                default = self._get_newtrade_filename()
                filepath = filedialog.asksaveasfilename(
                ...
                filename = self._get_newtrade_filename()
    ...
    def export_area_ranking_html(self, area_type):
        ...
        try:
            ...
            # 활성 리스트 이름으로 지역 판별
            active_list_name = self.active_list.get()
            if "서울" in active_list_name or "수도권" in active_list_name:
    ...
    def export_price_distribution_html(self):
        ...
        try:
            ...
            if region_filter:
                ...
                region_name = "부산"
            elif "경기" in list_name:
                region_name = "경기"
            elif "인천" in list_name:
                region_name = "인천"
            else:
            ...
            # D:\python work\newtrade 에 저장
            script_dir = os.path.dirname(os.path.abspath(__file__))
            save_dir = os.path.join(os.path.dirname(script_dir), "newtrade")
            os.makedirs(save_dir, exist_ok=True)
